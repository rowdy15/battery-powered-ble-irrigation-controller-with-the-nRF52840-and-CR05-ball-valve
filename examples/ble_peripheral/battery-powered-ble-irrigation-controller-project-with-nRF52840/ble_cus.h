...
#define CUSTOM_VALUE_CHAR_UUID_2          0x1402                                                 //     F3641402-00B0-4240-BA50-05CA45BF8ABC                                             //     F3641401-00B0-4240-BA50-05CA45BF8ABC
...
typedef enum
{
    ...
    BLE_CUS2_EVT_NOTIFICATION_ENABLED,                             /**< Custom value notification enabled event. */
    BLE_CUS2_EVT_NOTIFICATION_DISABLED,                             /**< Custom value notification disabled event. */
...
/**@brief   from the Nordic UART Service example @ref BLE_NUS_EVT_RX_DATA event data.
 *
